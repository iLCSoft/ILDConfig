#######################################
# based on ILDReconstruction.py
# only different Tracking sequences loaded
#######################################
...
sequenceLoader.load("Tracking/TrackingDigi_SiILD")
sequenceLoader.load("Tracking/ConformalTracking_SiILD")
