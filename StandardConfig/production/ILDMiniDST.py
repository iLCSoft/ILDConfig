...
LeptonID.Parameters = {
    "BuildTree": ["false"],
    "EvalMVA": ["true"],
    "weightfile": ["HighLevelReco/PIDFiles/CPID/LeptonID_multi_jet_dEdx_800t_3d_cm50r50_BDTG.weights.xml"],
}
...
ComprehensivePID_singleP.Parameters = {
    "CPID_singleP_16bins_cons.S": ["!V:!Silent:Color:DrawProgressBar:Transformations=I;D;P;G,D:AnalysisType=multiclass", "SplitMode=Random:NormMode=NumEvents:!V", "!V:!H:NTrees=1000:BoostType=Grad:Shrinkage=0.10:UseBaggedBoost:BaggedSampleFraction=0.50:nCuts=30:MaxDepth=5", "dEdx_RCD_piDis>-900&&dEdx_RCD_kaDis>-900"],
...
ComprehensivePID_2fZhad.Parameters = {
    "CPID_2fZhad_18bins_cons.S": ["!V:!Silent:Color:DrawProgressBar:Transformations=I;D;P;G,D:AnalysisType=multiclass", "SplitMode=Random:NormMode=NumEvents:!V", "!V:!H:NTrees=1000:BoostType=Grad:Shrinkage=0.10:UseBaggedBoost:BaggedSampleFraction=0.50:nCuts=30:MaxDepth=5", "dEdx_RCD_piDis>-900&&dEdx_RCD_kaDis>-900"],
    "PFOCollection": ["PandoraPFOs"],
    "RecoMCTruthLink": ["RecoMCTruthLink"],
    "TOF100.S": ["TOFEstimators100ps"],
    "TTreeFileName": [],
...
ParticleIDFilter.Parameters = {
    "FilterPIDAlgos": ["BasicVariablePID", "LikelihoodPID", "LowMomMuID", "ShowerShapesPID", "dEdxPID"],
    "RecoParticleCollection": ["PandoraPFOs"],
}
